...
public sealed class ResponsivePanel : Panel
{
    ...
    public static readonly StyledProperty<int> MaxColumnsProperty =
        AvaloniaProperty.Register<StackPanel, int>(nameof(MaxColumns), 1);
    
    public static readonly StyledProperty<bool> HorizontalContentStretchProperty =
        AvaloniaProperty.Register<StackPanel, bool>(nameof(HorizontalContentStretch));
    
    public static readonly StyledProperty<bool> VerticalContentStretchProperty =
        AvaloniaProperty.Register<StackPanel, bool>(nameof(VerticalContentStretch));
